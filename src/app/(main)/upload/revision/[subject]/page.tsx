        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
                <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-6">We could not find your user record in our system.</p>
                ...
                <header className="mb-8">
                    <div>
                        ...
                        <p className="text-gray-600">
                            Subject: <span className="font-medium text-gray-900">{subject.title}</span>
                        </p>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900 mb-2">Resource Materials</h2>
                            <p className="text-gray-600 mb-4">Upload study guides, notes, and other learning resources for students.</p>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900 mb-2">Test Revision Materials</h2>
                            <p className="text-gray-600 mb-4">Upload practice tests, sample questions, and test preparation guides.</p>
                        </div>
                        <div className="px-6 py-4 bg-gray-50">
                            <Link
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900 mb-2">Schedule a Test</h2>
                            <p className="text-gray-600 mb-4">Create and schedule new tests with deadlines and notifications.</p>
                        </div>
                        <div className="px-6 py-4 bg-gray-50">
                            <Link
