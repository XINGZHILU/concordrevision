...
// File: src/app/(teachers)/teachers/olympiads/new/page.tsx
...
export default function NewOlympiadPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/api/teachers/olympiads', {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                throw new Error('Failed to create olympiad');
            }
            ...
            toaster.error({
                title: "Error",
                description: "Failed to create olympiad. Please try again."
            });
        } finally {
            ...
            <div className="bg-card shadow-md rounded-lg p-6">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end">
                        ...
                        >
                            {isSubmitting ? 'Creating...' : 'Create Olympiad'}
                        </button>
                    </div>
                </form>
            </div>
