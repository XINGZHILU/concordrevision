...
/**
 * Pagination component for olympiad list
 */
...
export default function OlympiadList({ olympiads }: OlympiadListProps) {
  ...
  // Filter olympiads based on search term and selected area
  ...
  /**
   * Handle olympiad deletion
   */
  const handleDeleteOlympiad = async (olympiadId: number) => {
    setIsDeleting(true);

    try {
      const response = await fetch(`/api/teachers/olympiads/${olympiadId}`, {
        method: 'DELETE',
      });
                ...
                <tbody className="bg-card divide-y divide-border">
                    ...
                    <tr key={olympiad.id} className="hover:bg-accent">
                        ...
                        <div className="flex space-x-2">
                            ...
                            <Link
                                href={`/teachers/olympiads/${olympiad.id}`}
                            >
                                Edit
                            </Link>
                            </Button>
