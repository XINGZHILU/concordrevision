                ...
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <button
                            ...
                            className={`px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors ${(olympiadToDelete && olympiadToDelete._count.resources > 0) || isDeleting ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
