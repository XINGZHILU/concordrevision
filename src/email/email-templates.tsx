  ...
  <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', color: '#333' }}>
    <div style={{ maxWidth: '600px', margin: 'auto', border: '1px solid #ddd', borderRadius: '8px', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '20px' }}>
        <p>Dear {name},</p>
        <p>We are delighted to inform you that your uploaded resource, &quot;<b>{title}</b>,&quot; for <b>{area}</b>, has been <b>approved</b> and is now available to other students and teachers on Concord Student Hub.</p>
...
export const RejectedEmailTemplate: React.FC<Readonly<RejectedEmailTemplateProps>> = ({
  ...
  <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', color: '#333' }}>
    <div style={{ maxWidth: '600px', margin: 'auto', border: '1px solid #ddd', borderRadius: '8px', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '20px' }}>
        <p>Dear {name},</p>
        <p>We are writing to inform you about your recent submission, &quot;<b>{title}</b>,&quot; for <b>{area}</b>. After careful review, we regret to inform you that it has been <b>rejected</b>.</p>
