    ...
    return (
        <>
            <div className="w-full mx-auto bg-card rounded-lg shadow p-6">
                <div className="mb-6">
                    <h2 className="text-xl font-semibold text-card-foreground">Upload Olympiad Resource</h2>
                    <p className="text-muted-foreground mt-1">Share olympiad materials and resources</p>
                </div>
